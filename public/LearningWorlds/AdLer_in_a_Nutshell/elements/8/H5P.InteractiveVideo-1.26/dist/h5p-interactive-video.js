(() => {
    ...
    var $ = function (o) {
      ...
      P = function (o) {
        ...
        e.dnb.dialog.once("close", function () {
          ...
          (n && (n.focus(), n.attr("aria-expanded", "false")),
            d && d.trigger("hide"));
  ...
  const U = z,
    K = (
      ...
      (t.click(i), !0 !== o && I(t, [{ key: T.SPACE }, { key: T.ENTER }], i));
    };
  function G(t, e) {
    return (
    ...
    return (
      ...
      (i.update = function () {
        ...
        ((this.answered = e
          ...
          this.answered.forEach(function (e) {
            var o = e.getDuration().from,
              n = t.getDescription(e),
              i = e.getInstance(),
              s = i.getScore ? i.getScore() : void 0,
              r = i.getMaxScore ? i.getMaxScore() : void 0;
            t.$endscreenBottomTable.append(t.buildTableRow(o, n, s, r));
          }));
        var o = this.answered.length;
        (this.$endscreenIntroductionTitleText.html(
          this.l10n.title.replace("@answered", o),
        ),
          0 === o
            ? this.$endscreenIntroductionText.html(
                '<div class="'
            ...
            : this.$endscreenIntroductionText.html(
                this.isSubmitButtonEnabled
                  ? this.l10n.information.replace("@answered", o)
  ...
  function Z(t, e, o) {
    ...
    (H5P.EventDispatcher.call(s),
      ...
      o &&
        ...
        (s.previousState = o.previousState),
      (s.menuitems = []),
              ...
              s.video.on("qualityChange", function (t) {
                ...
                if (s.controls && s.controls.$qualityChooser) {
                  if ("YouTube" === this.getHandlerName()) {
                    ...
                    var o = s.qualities.filter(function (e) {
      ...
      if (this.controls.$bookmarksButton) {
        t =
          void 0 === t
            ...
            : t;
        var o = this.controls.$bookmarksChooser.hasClass("h5p-show");
    ...
    (Z.prototype.attachControls = function (t) {
      ...
      ((e.minimalMenuKeyboardControls = new b([new g()])),
        ...
        (e.controls.$slider = J("<div/>", {
          ...
          slide: function (t, o) {
            var n = x(t, [T.ARROW_LEFT, T.ARROW_RIGHT]),
              i = o.value;
