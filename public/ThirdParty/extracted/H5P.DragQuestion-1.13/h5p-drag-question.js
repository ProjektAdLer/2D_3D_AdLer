!(function (e) {
              ...
              v.on("elementremove", function (e) {
                a.drag.removeElement(e.data),
                  "true" === e.data.getAttribute("aria-grabbed") &&
                    (a.drag.firesEvent("select", e.data),
            ...
            for (var t = e.data, n = 0; n < r.draggables.length; n++) {
              ...
              if (i && i.elements && i.elements.length)
                for (var o = 0; o < i.elements.length; o++) {
                  var a = i.elements[o];
                  if (a && a.$[0] === t[0])
                    return void (a.position = f.default.positionToPercentage(
                      r.$container,
                      a.$
                    ));
                }
    ...
    (o.prototype = Object.create(H5P.Question.prototype)),
      ...
      (o.prototype.registerDomElements = function () {
        ...
        if (
          ...
          !1 !== H5P.canHasFullScreen &&
            this.options.behaviour.enableFullScreen)
        ) {
          var n = function () {
              H5P.isFullscreen
        ...
        for (t = 0; t < this.options.question.task.dropZones.length; t++)
          if (
            ...
            for (
              var r = 0;
              r <
              this.options.question.task.dropZones[t].correctElements.length;
              r++
            ) {
              ...
              !s ||
                ...
                (e.correctResponsesPattern[0] +=
                  t + "[.]" + a.dropZones[t].correctElements[r]),
                (o = !1));
            }
        return e;
      }),
      ...
      (o.prototype.getAnswerGiven = function () {
        return (
          !this.options.behaviour.showSolutionsRequiresInput ||
          this.answered ||
          this.blankIsCorrect
        );
      }),
      ...
      var o,
        r = function () {
          o.draggable.trigger("dragend"),
            ...
            f.default.setElementOpacity(
              o.element.$,
              o.draggable.backgroundOpacity
            ),
        ...
        i.drop.on("select", function (e) {
          if (o) {
            ...
            o.draggable.mustCopyElement(o.element) && o.element.clone(),
              ...
              -1 === i.getIndexOf(o.element.$) &&
                i.alignables.push(o.element.$),
              i.autoAlign(),
              o.element.$[0].setAttribute("aria-grabbed", "false"),
              r();
          }
  ...
  function (e, t, n) {
    ...
    var o = (function () {
      ...
      c = (0, a.compose)(
        (0, a.forEach)((0, r.setAttribute)("aria-grabbed", "false")),
        u
      ),
                  ...
                  var e,
                    ...
                    o = {
                      x:
                        ...
                        100,
                      y:
                        (n.autoAlignable.spacing /
                          n.autoAlignable.size.height) *
                        100,
                    },
                ...
                null === e
                  ...
                  (i.$ = u("<div/>", {
                    ...
                    .draggable({
                      ...
                      stop: function () {
                        var n = u(this);
                        (i.position = l.default.positionToPercentage(t, n)),
                          n.css(i.position);
                        var r = n.data("addToZone");
                        void 0 !== r
                          ? (n.removeData("addToZone"),
                            o.addToDropZone(e, i, r))
                          : i.reset();
                      },
                    })
                    .css("position", "")),
            ...
            },
            {
              ...
              value: function () {
                for (var e = this, t = 0; t < e.elements.length; t++) {
                  var n = e.elements[t];
                  n &&
                    (n.$.draggable("enable"), e.trigger("elementadd", n.$[0]));
                }
              },
            },
            {
