...
(function () {
          ...
          on: function (b, c, l, h, k) {
            ...
            if (0 > y.getListenerIndex(c)) {
              ...
              for (var z = y.length - 1; 0 <= z; z--)
                if (y[z].priority <= k)
                  return y.splice(z + 1, 0, p), { removeListener: f };
              y.unshift(p);
            }
    ...
    function a(a, b, c) {
      ...
      this.input = function () {
        ...
        if (!f._scheduledTimer || !1 !== f._reschedule()) {
          ...
          x < f._minInterval
            ? (f._scheduledTimer = setTimeout(a, f._minInterval - x))
            : a();
        }
      };
    }
    ...
    CKEDITOR.tools = {
      ...
      keystrokeToArray: function (a, b) {
        var c = b & 16711680,
          ...
          k = [];
        c & CKEDITOR.CTRL &&
          (n.push(h ? "⌘" : a[17]), k.push(h ? a[224] : a[17]));
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
        ...
        if (
          ...
          H &&
            ...
            (CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
              ? ((b = d.$.scrollLeft || l.scrollLeft),
                (c = d.$.scrollTop || l.scrollTop))
          ...
          for (
            w = this, n = null;
            w && "body" != w.getName() && "html" != w.getName();

          ) {
            b += w.$.offsetLeft - w.$.scrollLeft;
            c += w.$.offsetTop - w.$.scrollTop;
            w.equals(this) ||
              ((b += w.$.clientLeft || 0), (c += w.$.clientTop || 0));
            for (; n && !n.equals(w); )
      ...
      scrollIntoParent: function (a, b, c) {
        ...
        function w(a, b) {
          ...
          f = a.getWindow();
          f.equals(b) ||
            ((f = w(CKEDITOR.dom.element.get(f.$.frameElement), b)),
            (c.x += f.x),
            (c.y += f.y));
          return c;
        }
        ...
        a instanceof CKEDITOR.dom.window &&
          (a = H ? e.getBody() : e.getDocumentElement());
        CKEDITOR.env.webkit &&
          (e = this.getEditor(!1)) &&
        ...
        : (a
            ...
            : ((f = d),
              f.type == CKEDITOR.NODE_ELEMENT &&
                ((f = f.getChild(e)) ||
                  (f =
                    !1 === x(d, !0) ? null : d.getNextSourceNode(!0, m, x)))),
          f && !1 === x(f) && (f = null));
      for (; f && !this._.end; ) {
        this.current = f;
  ...
  (function () {
    ...
    function d(a, b, c, d, e) {
      ...
      if (
        ...
        (m.equals(G) ||
          (m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(G)))
      )
        ...
        B = c;
        for (U = O; U <= v; U++)
          if (((c = t[U]), (aa = c.getPrevious()), c.equals(S[U])))
            b && (B = B.getChild(0));
          else {
    ...
    CKEDITOR.dom.range.prototype = {
      ...
      createBookmark: function (a) {
        ...
        e ||
          ...
          (l = this.clone()),
          b(d) &&
            ((d = b(d)), l.moveToPosition(d, CKEDITOR.POSITION_AFTER_END)),
          l.collapse(),
          l.insertNode(n));
        l = this.clone();
        b(c) &&
          ((d = b(c)), l.moveToPosition(d, CKEDITOR.POSITION_BEFORE_START));
        l.collapse(!0);
        l.insertNode(g);
        n
      ...
      enlarge: function (a, b) {
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            A.type == CKEDITOR.NODE_TEXT
              ? (r &&
                  ((A = !CKEDITOR.tools.trim(A.substring(0, r)).length && A),
                  (L = !!A)),
            ...
            for (k = c(k); k || m; ) {
              ...
              for (; m; )
                if (((A = !1), m.type == CKEDITOR.NODE_COMMENT))
                  m = m.getPrevious();
                else {
                  if (m.type == CKEDITOR.NODE_TEXT)
                    ...
                    (m.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) ||
                      (b && m.is("br"))) &&
                    !m.data("cke-bookmark")
                  )
                    if (L && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                      ...
                      if (d.test(M)) m = null;
                        ...
                        for (
                          var r = m.$.getElementsByTagName("*"), F = 0, E;
                          (E = r[F++]);
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            this.setStartAt(
              u,
              !u.is("br") &&
                ((!k && this.checkStartOfBlock()) || (k && u.contains(k)))
      ...
      splitBlock: function (a, b) {
        ...
        e &&
          e.equals(g) &&
          (d
            ? ((n = new CKEDITOR.dom.elementPath(
                this.startContainer,
                this.root
              )),
              this.moveToPosition(g, CKEDITOR.POSITION_AFTER_END),
    ...
    a.prototype = {
      getNextParagraph: function (a) {
        ...
        if (!this._.started) {
          ...
          l =
            w.endContainer.hasAscendant("pre", !0) ||
        ...
        for (this._.nextNode = null; n; ) {
          ...
          if (I) n.type == CKEDITOR.NODE_TEXT && g.test(n.getText()) && (I = 0);
            ...
            if (
              ...
              n.isBlockBoundary(this.forceBrBreak && !q && { br: 1 })
            ) {
              if ("br" == m) I = 1;
              ...
              l &&
                (l.setEndAt(n, CKEDITOR.POSITION_BEFORE_START),
                "br" != m && (this._.nextNode = n));
              H = 1;
            } else {
              if (n.getFirst()) {
                l ||
                  ((l = this.range.clone()),
                  l.setStartAt(n, CKEDITOR.POSITION_BEFORE_START));
                n = n.getFirst();
                continue;
              }
              I = 1;
        ...
        this._.nextNode ||
          (this._.nextNode =
            y || d.equals(w) || !w ? null : this._getNextSourceNode(d, 1, w));
        return d;
      },
  ...
  (function () {
    function a(a, b, c, d, e) {
      ...
      for (f in b) {
        ...
        for (r in Q) {
          ...
          for (O in h)
            "!" == O.charAt(0) &&
              ((O = O.slice(1)), u.push(O), (n[O] = !0), (B = !1));
          ...
          if (
            ...
            if (a)
              if (!0 === a) a = !0;
                ...
                for (var f = 0, g = c.length, m; f < g; ++f)
                  (m = c[f]), e[m] || (e[m] = a(m));
                a = !1;
              }
            else a = !1;
      ...
      if ((e = a.requiredClasses))
        for (f = b.classes, c = 0; c < e.length; ++c)
          if (((d = e[c]), "string" == typeof d)) {
            ...
            return !1;
      return (
        k(b.styles, a.requiredStyles) && k(b.attributes, a.requiredAttributes)
      );
    }
    function k(a, b) {
      if (!b) return !0;
    ...
    function I(a) {
      return (
        a.type == CKEDITOR.NODE_ELEMENT && ("br" == a.name || r.$block[a.name])
      );
    }
    function K(a, b, c) {
      var d = a.name;
    ...
    function G(a, b) {
      ...
      for (f in d)
        if ("class" == f)
          for (
            c = d[f].split(/\s+/), g = a.classes.join("|");
            (v = c.pop());
      ...
      if (c && !b) {
        ...
        !0 === d
          ...
          : (d || (this.customConfig = !1),
            ...
            this.allow(
              u[c.enterMode] + " " + u[c.shiftEnterMode],
              "default",
              1
            ),
        ...
        for (; (E = a.pop()); )
          if (((c = E.el), c.parent))
            switch (((h = r[c.parent.name] || r.span), E.check)) {
              case "it":
                r.$removeEmpty[c.name] && !c.children.length
                  ? K(c, d, a)
                  : n(c) || K(c, d, a);
                break;
              case "el-up":
  ...
  (function () {
    ...
    function z(a, b) {
      ...
      for (
        var e = new CKEDITOR.dom.documentFragment(), f, g, h, l = 0;
        l < a.length;
        l++
      ) {
        var k = a[l],
        ...
        c(k)
          ? (f ||
              ...
              f.append(
                r.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()
              ),
              e.append(f),
          ...
          if ("br" == e) H.push(f);
            ...
            for (
              ...
              if (q.isOptionalClose) C.onTagClose(g);
                ...
                !f.returnPoint && (f.returnPoint = q), (q = q.parent);
              else if ((g in CKEDITOR.dtd.$inline && n.unshift(q), q.parent))
                x(q, q.parent, 1);
              else {
                f.isOrphan = 1;
                break;
  ...
  (function () {
    ...
    CKEDITOR.inlineAll = function () {
      ...
      for (b in CKEDITOR.dtd.$editable)
        for (
          var c = CKEDITOR.document.getElementsByTag(b), g = 0, e = c.count();
          g < e;
          g++
        )
          (a = c.getItem(g)),
    ...
    CKEDITOR.editor.prototype.setMode = function (a, b) {
      ...
      if (a != d.mode && l && l[a]) {
        ...
        if (d.mode) {
          ...
          "source" == d.mode &&
            l == k &&
            (d.fire("lockSnapshot", { forceUpdate: !0 }), (p = 1));
  ...
  (function () {
            ...
            if (l) {
              ...
              r
                ...
                : ((l = g.appendStyleText(l)),
                  (l = new CKEDITOR.dom.element(
                    l.ownerNode || l.owningElement
                  )),
                  ...
                  (f = e(b))
                    ...
                    : g.collapsed &&
                      ...
                      g[c ? "checkStartOfBlock" : "checkEndOfBlock"]()
                        ? (a.fire("saveSnapshot"),
                          g[c ? "checkEndOfBlock" : "checkStartOfBlock"]() &&
                            r.remove(),
    ...
    n = (function () {
      ...
      return function (t, u, J, v) {
        ...
        if (!v.checkReadOnly()) {
          var z =
            new CKEDITOR.dom.elementPath(v.startContainer, v.root).blockLimit ||
            v.root;
          u = {
            type: u,
            dontFilter: D,
          ...
          if ((q = C.contains(f, !1, 1)))
            (x = D.splitElement(q)),
              (u.inlineStylesRoot = q),
              (u.inlineStylesPeak = C.lastElement);
          C = D.createBookmark();
          y && (k(q), k(x));
            ...
            for (F(B, P); x < B.length; x++) {
              ...
              if ((y = D.isLineBreak))
                (y = P),
                  ...
                  D.hasBlockSibling
                    ? (y = 1)
                    : (T = y.startContainer.getAscendant(E.$block, 1)) &&
                      T.is({ div: 1, p: 1 })
                    ? ((H = T.getPosition(q)),
                      H == CKEDITOR.POSITION_IDENTICAL ||
                      H == CKEDITOR.POSITION_CONTAINS
                        ? (y = 0)
                        : ((q = y.splitElement(T)),
              ...
              if (y) J = 0 < x;
                ...
                D.lastNotAllowed &&
                  x < B.length - 1 &&
                  ((K = z ? Z : K) &&
                    P.setEndAt(K, CKEDITOR.POSITION_AFTER_START),
                  (C = 0));
                P.collapse();
              }
            }
          ...
          for (I = R.createBookmark(); (N = u.zombies.pop()); )
            N.getParent() &&
              ((K = R.clone()),
              K.moveToElementEditStart(N),
              K.removeEmptyBlocksAtEnd());
          if (ba)
            for (; (N = ba.pop()); )
              CKEDITOR.env.needsBrFiller
                ? N.appendBogus()
                : N.append(R.document.createText(" "));
          ...
          CKEDITOR.env.webkit &&
            ...
            N.block
              ? N.block.$.normalize()
              : N.blockLimit && N.blockLimit.$.normalize());
          R.moveToBookmark(I);
          if (!u.dontMoveCaret) {
            for (N = e(R); N && a(N) && !N.is(E.$empty); ) {
              if (N.isBlockBoundary())
                R.moveToPosition(N, CKEDITOR.POSITION_BEFORE_END);
              else {
        ...
        table: (function () {
          ...
          return {
            ...
            detectRanges: function (e, f) {
              ...
              k.is(CKEDITOR.dtd.$tableContent) &&
                !k.is(d) &&
                (k = k.getAscendant("table", !0));
              t = k;
    ...
    CKEDITOR.on("instanceCreated", function (a) {
      ...
      c.on("contentDom", function () {
        ...
        k.attachListener(
          ...
          function () {
            if (F && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
              F =
                c._.previousActive && c._.previousActive.equals(g.getActive());
              var a =
          ...
          n
            ...
            k.attachListener(
              ...
              function () {
                ...
                (CKEDITOR.env.gecko && !p && a) ||
                  (c.lockSelection(y), (F = 1));
              },
              null,
              null,
              -1
              ...
              m.on("mousedown", function (a) {
                function b(a) {
                  ...
                  if (w) {
                    ...
                    w.setEndPoint(
                      0 > z.compareEndPoints("StartToStart", c)
                        ? "EndToEnd"
                        : "StartToStart",
                      c
                    );
        ...
        if (p && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
          ...
          k.attachListener(
            CKEDITOR.env.ie ? k : g.getDocumentElement(),
            "mouseup",
            l,
            c
          );
              ...
              if (n) {
                ...
                l
                  ...
                  : ((v = J.getNext(m)),
                    ...
                    (v =
                      ...
                      (B ||
                        !J.hasPrevious() ||
                        (J.getPrevious().is && J.getPrevious().is("br")))),
                ...
                for (D = 0; D < a.length; D++) {
                  ...
                  b.collapsed &&
                    ...
                    "br" == v.getName()
                      ? (x(this.root),
                        b.moveToPosition(v, CKEDITOR.POSITION_BEFORE_START))
  ...
  (function () {
          ...
          if (q.equals(y)) (q = null), (k = !0);
            ...
            if (w && m && CKEDITOR.dtd.$block[u])
              for (
                ...
                if (L ? L.check(this) : 1)
                  A.selectNodeContents(G), b.call(this, A);
              }
    ...
    function C(a) {
      for (
        var b = K(this), c = a.getElementsByTag(this.element), d, e = c.count();
        0 <= --e;
    ...
    CKEDITOR.tools.color = CKEDITOR.tools.createClass({
      ...
      _: {
        ...
        extractColorChannelsFromHsla: function (b) {
          ...
          b && (f = d(c[3], CKEDITOR.tools.color.MAX_ALPHA_CHANNEL_VALUE));
          g.push(f);
          return this._.areColorChannelsValid(g[0], g[1], g[2], g[3])
            ? g
            : null;
        },
        ...
        hslToRgb: function (a, b, c) {
          var d = function (d) {
            ...
            f = Math.max(-1, f);
            return Math.round(
              (c - d * f) * CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE
            );
          };
          return [d(0), d(8), d(4)];
        },
      ...
      do
        if (k.type == CKEDITOR.NODE_ELEMENT) {
          ...
          if (
            !l &&
            ((p = k.getName()),
            "true" == k.getAttribute("contenteditable")
              ? (l = k)
              : !e && d[p] && (e = k),
            a[p])
          ) {
            ...
            if (h && 1 < a.length) {
              if (!e)
                for (var k = a.length - 1; 0 <= k; k--)
                  d.unshift(a[k].createBookmark(!0));
              if (l)
                for (var p = 0; a[e + p + 1]; ) {
                  var f = h.document;
                  l = 0;
                  ...
                  for (f = f.getById(d[p + 1].startNode); ; ) {
                    ...
                    if (f.equals(k)) l = 1;
                      ...
                      c(k) ||
                      (k.type == CKEDITOR.NODE_ELEMENT && k.isBlockBoundary())
                    )
                      continue;
                    break;
                  }
              ...
              for (h.moveToBookmark(d.shift()); p--; )
                (k = a[++e]),
                  k.moveToBookmark(d.shift()),
                  h.setEnd(k.endContainer, k.endOffset);
            }
            return h;
          },
        };
      ...
      if (!CKEDITOR.env.ie || !CKEDITOR.env.quirks) {
        ...
        a = function (a) {
          ...
          if (!a.getById("cke_ui_color")) {
            ...
            (a = b.getUiColor()) &&
              g([d], CKEDITOR.skin.chameleon(b, "panel"), [[k, a]]);
          }
        };
        b.on("panelShow", a);
        b.on("menuShow", a);
      ...
      proto: {
        ...
        getMatchingValue: function (a, b) {
          for (var c = b.elements, d = 0, e; d < c.length; d++)
            if (((e = c[d]), (e = this._.findMatchingStyleName(a, e))))
              return e;
          return null;
        },
      },
