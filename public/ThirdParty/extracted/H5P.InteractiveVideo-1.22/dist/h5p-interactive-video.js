    ...
    (i.prototype = Object.create(H5P.EventDispatcher.prototype)),
      ...
      (i.prototype.setCaptionTracks = function (t) {
        ...
        i || (i = t[0]),
          ...
          e.controls.$volume
            ...
            : k(e.captionsTrackSelector.control).insertAfter(
      ...
      (i.prototype.addControls = function () {
        ...
        if (
          ...
          for (
            var s = !1,
              a = this.getDuration(),
              c = this.options.assets.endscreens.length - 1;
            c >= 0;
            c--
          ) {
      ...
      (i.prototype.addSliderInteractions = function () {
        ...
        this.controls.$interactionsContainer.children().remove(),
          ...
          e.interactionKeyboardControls.on(
            "afterPreviousElement",
            function (e) {
              return t.handleInteractionTabIndex(e);
            }
          );
    ...
    function o(t, e, n) {
      ...
      var g,
        ...
        T = [
          ...
          C ? a(t.label) : "",
          "H5P.Link" === $ && void 0 !== b.params.title
            ? b.params.title
            : t.libraryTitle,
        ].filter(s)[0],
        x = !1,
        ...
        L = function (n) {
          ...
          if (
            ...
            if (C.length && "none" !== C.css("display")) {
              var T =
                2 * parseFloat(C.css("right")) +
                2 * parseFloat(C.css("padding-right"));
              w.css({ right: T + "px" });
            }
            s.append(w);
          }
          ...
          s(e, [
            {
              ...
              value: function () {
                ...
                (this.$endscreenIntroductionText = l("<div/>", {
                  ...
                  (this.$endscreenOverviewTitle = l("<div/>", {
                    class: c + "-overview-title",
                  })
                    .append(
                      l("<div/>", {
                  ...
                  (this.$endscreenBottomTable = l("<div/>", {
                    class: c + "-overview-table",
                  })),
                  (this.$endscreen = l("<div/>", {
                    ...
                    .append(
                      l("<div/>", { class: c + "-introduction" })
                        ...
                        .append(
                          l("<div/>", {
                            class: c + "-introduction-container",
                          }).append([
                            e,
            ...
            },
            {
              ...
              value: function (t, e, n, o) {
                var i = this,
                  ...
                  u = this.parent.skippingPrevented()
                    ? " " + c + "-no-link"
                    : "",
                  h = l("<div/>", {
