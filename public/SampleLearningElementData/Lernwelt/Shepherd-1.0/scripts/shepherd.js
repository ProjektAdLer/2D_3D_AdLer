...
(function (root, Tether, factory) {
  ...
  var Step = (function (_Evented) {
    function Step(tour, options) {
      ...
      _get(Object.getPrototypeOf(Step.prototype), "constructor", this).call(
        this,
        tour,
        options,
      );
    ...
    _createClass(Step, [
      ...
      },
      {
        ...
        value: function bindAdvance() {
          ...
          var _parseShorthand = parseShorthand(this.options.advanceOn, [
            "selector",
            "event",
          ]);
      ...
      },
      {
        ...
        value: function getAttachTo() {
          var opts =
            parseShorthand(this.options.attachTo, ["element", "on"]) || {};
          ...
          if (typeof selector === "string") {
            ...
            if (!opts.element) {
              throw new Error(
                "The element for this Shepherd step was not found " + selector,
              );
            }
          }
      ...
      },
      {
        ...
        value: function setupTether() {
          ...
          this.tether = new Tether(
            extend(tetherOpts, this.options.tetherOptions),
          );
        },
      },
      {
      ...
      },
      {
        ...
        value: function render() {
          ...
          if (typeof this.options.title !== "undefined") {
            header.innerHTML +=
              "<h3 class='shepherd-title'>" + this.options.title + "</h3>";
  ...
  var Tour = (function (_Evented2) {
    function Tour() {
      ...
      _get(Object.getPrototypeOf(Tour.prototype), "constructor", this).call(
        this,
        options,
      );
      this.bindMethods();
