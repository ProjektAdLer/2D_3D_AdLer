H5P.CKEditor = (function (EventDispatcher, $) {
  var DefaultCKEditorConfig = {
    ...
    removeButtons:
      "Blockquote,Source,HorizontalRule,RemoveFormat,SpecialChar,Maximize,Image,Cut,Copy,Paste,Undo,Redo,Anchor,Subscript,Superscript,Font,BulletedList,NumberedList,Outdent,Indent,About",
  };
  ...
  function CKEditor(
    ...
    self.create = function () {
      loadCKEditor(
        H5P.getLibraryPath("H5P.CKEditor-1.0") + "/ckeditor/",
        targetId,
        self,
      );
    };
    ...
    var resizeDialog = function (dialog) {
      ...
      // Resize link dialog
      var dialogContentsBody = dialogElement.find(".cke_dialog_contents_body")
        .$[0];
