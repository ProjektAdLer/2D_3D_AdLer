(() => {
  ...
  const t = function (t) {
    ...
    r = t((t, e, n) => n.setAttribute(t, e)),
    a = t((t, e) => e.removeAttribute(t)),
    c = t((t, e) => e.hasAttribute(t)),
    l =
      (t((t, e, n) => n.getAttribute(t) === e),
      t((t, e) => {
        const n = s(t, e);
        r(t, ("true" !== n).toString(), e);
      }),
      t((t, e) => t.appendChild(e)),
      t((t, e) => e.querySelector(t)),
      t((t, e) => {
        return ((n = e.querySelectorAll(t)), Array.prototype.slice.call(n));
        var n;
      }),
  ...
  class b {
    constructor(t) {
      (Object.assign(this, {
        ...
        propagate: function (t, e) {
          let n = this;
          t.forEach((t) => e.on(t, (e) => n.fire(t, e)));
        },
      }),
        (this.plugins = t || []),
        (this.elements = []),
    ...
    previousElement({ index: t }) {
      const e = 0 === t,
        n = this.elements[e ? this.elements.length - 1 : t - 1];
      (this.setTabbable(n), n.focus());
    }
    useNegativeTabIndex() {
  ...
  const C = S,
    ...
    x = (t, e, n = { ctrl: !1, shift: !1 }) =>
      -1 !== e.indexOf(t.which) &&
      !(n.ctrl && !t.ctrlKey) &&
      !(n.shift && !t.shiftKey),
    P = (t) => -1 !== [T.ENTER, T.SPACE].indexOf(t.which),
    I = (t, e, n) => {
      t.on("keydown", (t) => {
        for (let o = 0; o < e.length; o++) {
          const i = e[o];
          if (x(t, [i.key], { ctrl: i.ctrl, shift: i.shift }))
            return (i.preventDefault && t.preventDefault(), n(t));
        }
      });
    };
  function E(t) {
  ...
  function q(t, e, n) {
    ...
    var S = function (n) {
        ((o = B("<div/>", {
          tabindex: 0,
          role: "button",
          class: "h5p-interaction " + l + (n ? "" : " h5p-hidden"),
          "aria-popup": "true",
          "aria-expanded": "false",
          "aria-label": f,
          ...
          on: {
            click: function () {
              a.dialogDisabled || (P(), o.attr("aria-expanded", "true"));
            },
            keydown: function (t) {
              (13 !== t.which && 32 !== t.which) ||
                a.dialogDisabled ||
                (P(), o.attr("aria-expanded", "true"), t.preventDefault());
            },
          },
        })),
          a.getRequiresCompletion() &&
            ...
            P(!0),
          B("<div/>", { class: "h5p-touch-area" }).appendTo(o),
          B("<div/>", { class: "h5p-interaction-button" }).appendTo(o),
          e.editor &&
            o
              .hover(
                function () {
                  ...
                  (e.dnb && (!e.dnb || e.dnb.newElement))
                    ...
                    : (e.editor.showInteractionTitle(f, o), (b = !0));
                },
                function () {
                  (e.editor.hideInteractionTitle(), (b = !1));
                },
        ...
        var s = M(A(t.label));
        (t.label && s && (i = $(t.label, "h5p-interaction").appendTo(o)),
          a.trigger("display", o),
          setTimeout(function () {
            o && o.removeClass("h5p-hidden");
          }, 0));
      },
      $ = function (t) {
        var e =
      ...
      T = function (t) {
        ...
        (d && d.trigger("hide"),
          ...
          a.isButton()
            ...
            : (e.isMobileView && n && e.dnb.dialog.close(), o && o.detach()),
          a.trigger("remove", o),
          n && N(o));
      },
      x = function (t) {
      ...
      P = function (n) {
            ...
            i.keydown(function (t) {
              !(function (t, e) {
                ...
                o && e.shiftKey && n(i)
                  ...
                  : o && n(s) && (i.focus(), e.preventDefault());
        ...
        e.dnb.dialog.once("close", function () {
          ...
          (o && (o.focus(), o.attr("aria-expanded", "false")),
            d && d.trigger("hide"));
        ...
        if (
          ...
          var m = e.dnb.dialog.getMaxSize(o),
            v = u.find("img");
          c.params.file.width && c.params.file.height
            ...
            : (v.on("load", function () {
              ...
              e.dnb.dialog.position(o));
        } else if (!e.isMobileView) {
          var f = null;
          ("H5P.FreeTextQuestion" === p
            ? (f = "big")
            : "H5P.Text" !== p && "H5P.Table" !== p && (f = "medium"),
            e.dnb.dialog.position(o, { width: a.dialogWidth / 16 }, f));
        }
        if ("H5P.Summary" === p) {
          var b = 0;
      ...
      I = function (t, n, i, s) {
        ((i.width /= 16),
          (i.height /= 16),
          i.height > n.height &&
            ((i.width = (i.width * n.height) / i.height),
            (i.height = n.height)),
          i.width > n.width &&
            ((i.height = (i.height * n.width) / i.width), (i.width = n.width)));
        var r = 16 / Number(t.css("fontSize").replace("px", ""));
        (t.css({ width: i.width * r + "em", height: i.height * r + "em" }),
          s && e.dnb.dialog.position(o, i));
      },
      V = function (n) {
        (a.isButton() && e.dnb.dialog.close(),
          (e.currentState !== H5P.Video.PAUSED &&
            ...
            e.play());
        var o = n.data;
        (o === t.duration.from && (o += 0.2), e.seek(o, { force: !0 }));
      },
      q = function () {
        var n = t.height || 10,
          o = t.width || 10,
        ...
        if (
          ...
          if (u[3])
            0 === parseFloat(u[3].replace(")", "")) &&
              o.addClass("h5p-transparent-interaction");
        }
        (!1 === c.boxShadow && o.addClass("h5p-box-shadow-disabled"),
          "H5P.Link" === p &&
            (o.css("height", "auto"),
            o.css("width", "auto"),
            void 0 === e.editor &&
          ...
          (r = B("<div>", { class: "h5p-interaction-outer" }).appendTo(o)),
          (s = B(n ? "<a>" : "<div>", {
            class: "h5p-interaction-inner h5p-frame",
          }).appendTo(r)),
          !n && O(p) && s.attr("tabindex", "0"),
      ...
      F = function () {
        ...
        if (
          ...
          var r = i ? "correct" : "wrong",
            c = n.seekLabel ? n.seekLabel : e.l10n.defaultAdaptivitySeekLabel;
          (d
    ...
    ((a.isGotoClickable = function () {
      ...
      (a.addDot = function () {
        if ("H5P.Nil" === p) return B("<div/>", { class: n });
        var n = "h5p-seekbar-interaction " + l,
          o = B("<div/>", {
            role: "menuitem",
            class: n,
            ...
            on: {
              ...
              keydown: function (t) {
                if (13 === t.which || 32 === t.which)
                  return (a.selectDot(), !1);
              },
            },
          });
        return (
          e.preventSkipping &&
            o.attr("aria-disabled", "true").attr("tabindex", "-1"),
          (a.$menuitem = o),
          o
        );
      }),
      ...
      (a.toggle = function (n, i) {
        return a.visibleAt(n)
          ? o
            ? void 0
            : ((y = !0),
              a.isStandaloneLabel() ? w() : a.isButton() ? S(i) : W(),
              void 0 === e.editor
                ? (h = e.dnb.add(o, void 0, {
                    dnbElement: h,
                    disableContextMenu: !0,
                  }))
                : (a.fit && (e.editor.fit(o, t), (a.fit = !1)),
                  o.focus(function () {
                    e.pause();
                  })),
              o)
      ...
      (a.reCreateInteraction = function () {
        "H5P.IVHotspot" !== p &&
          ...
          a.trigger("hide", o),
          o.detach(),
          a.isStandaloneLabel() ? w() : a.isButton() ? S(!0) : W());
      }),
      ...
      (a.positionLabel = function (t) {
        o &&
          ...
          parseInt(o.css("left")) + i.position().left + i.outerWidth() > t &&
            i.addClass("h5p-left-label"));
      }),
      (a.setPosition = function (e, n) {
        ((t.x = e), (t.y = n), o.css({ left: e + "%", top: n + "%" }));
      }),
      (a.setSize = function (e, n) {
        (e && (t.width = e), n && (t.height = n), H5P.trigger(d, "resize"));
      }),
      (a.remove = function () {
        o &&
          (a.trigger(
            "domHidden",
            { $dom: o, key: "videoProgressedPast" },
      ...
      (a.reCreate = function () {
        ((l = (function () {
          var e = t.className;
          if (void 0 === e) {
            var n = c.library.split(" ")[0].toLowerCase().split(".");
    ...
    ((a.setDnbElement = function (t) {
      ...
      (a.getCopyrights = function () {
        if (!a.isStandaloneLabel()) {
          var n = H5P.newRunnable(c, e.contentId);
          if (void 0 !== n) {
            var o = new H5P.ContentCopyrights();
            return (
              o.addContent(H5P.getCopyrights(n, t, e.contentId)),
              o.setLabel(
                f +
                  " " +
      ...
      (a.repositionToWrapper = function (e) {
        if (o && "H5P.IVHotspot" !== p && "H5P.FreeTextQuestion" !== p) {
          if (
            (g &&
              (o.css({ top: t.y + "%", left: t.x + "%" }),
              o.css(a.isButton() ? { height: "", width: "" } : q()),
              (g = !1)),
            o.position().top + o.height() > e.height())
          ) {
            var n = ((e.height() - o.height()) / e.height()) * 100;
            if (n < 0) {
              n = 0;
              var i = e.height() / parseFloat(o.css("font-size"));
              o.css("height", i + "em");
            }
            (o.css("top", n + "%"), (g = !0));
          }
          if (o.position().left + o.width() > e.width()) {
            var s = ((e.width() - o.width()) / e.width()) * 100;
            if (s < 0) {
              s = 0;
              var r = e.width() / parseFloat(o.css("font-size"));
              o.css("width", r + "em");
            }
            (o.css("left", s + "%"), (g = !0));
          }
    ...
    z = (function () {
      function t(t) {
        ...
        ((this.$reference = t),
          ...
          (this.mode = e.mode),
          (this.focus = e.focus),
          (this.$tail = W("<div/>", { class: "".concat(this.style, "-tail") })),
          (this.$innerTail = W("<div/>", {
      ...
      return (
        (e.update = function () {
          ...
          ("centered" === this.mode &&
            this.$bubble.css({
              bottom: void 0 === o.bottom ? void 0 : "".concat(o.bottom, "px"),
        ...
        (e.getBubblePosition = function (t, e, n) {
          var o = t / 2;
          return {
        ...
        (e.fullscreen = function () {
          var t =
            ...
            s = { maxHeight: "", top: "" };
          (i &&
            ((s.maxHeight = "calc(".concat(n, "px - 1em - 9px)")),
            (s.top = "calc(((".concat(e - n, "px + 1em) / 2) - 9px)"))),
  ...
  const U = z,
    K = (
      t,
      e,
      { ignoreKeyboard: n = !1, preventDefaultForKeys: o = !0 } = {},
    ) => {
      const i = (t) => {
        ("click" !== t.type && o && t.preventDefault(), e(t));
      };
      (t.click(i), !0 !== n && I(t, [{ key: T.SPACE }, { key: T.ENTER }], i));
    };
  function G(t, e) {
    return (
  ...
  const X = (function (t) {
    ...
    function o(e) {
      ...
      return (
        ...
        (n.isSubmitButtonEnabled = n.parent.isSubmitButtonEnabled),
        n.buildDOM(),
        n
      );
    }
    ...
    return (
      ...
      (i.buildTableRow = function (t, e, n, o) {
        var i = this,
          s = _(n) && _(o),
          r = s
        ...
        return (
          ...
          Q("<div/>", {
            ...
            html: s ? "".concat(n, " / ").concat(o) : this.l10n.answeredScore,
            appendTo: c,
            "aria-hidden": !0,
          }),
          c
      ...
      (i.update = function () {
        ...
        ((this.answered = e
          ...
          this.answered.forEach(function (e) {
            ...
            t.$endscreenBottomTable.append(t.buildTableRow(n, o, s, r));
          }));
  ...
  function Z(t, e, n) {
    ...
    (H5P.EventDispatcher.call(s),
      ...
      (s.isSubmitButtonEnabled =
        void 0 === n ||
        void 0 === n.isScoringEnabled ||
        void 0 === n.isReportingEnabled ||
        n.isScoringEnabled ||
        n.isReportingEnabled),
      (s.bookmarksMenuId =
      ...
      void 0 !== t.override &&
        ...
        (s.preventSkippingMode = t.override.preventSkippingMode || "none"),
      ...
      (s.justVideo = !1));
    var r = navigator.userAgent.match(/(iPhone|iPod) OS (\d*)_/i);
    (null !== r && 3 === r.length && (s.justVideo = r[2] < 10),
      0 ===
        (o =
      ...
      (this.maxTimeReached =
        s.previousState && s.previousState.maxTimeReached
          ? s.previousState.maxTimeReached
          : 0),
      (s.interactionsProgress = []),
      s.previousState &&
        s.previousState.interactionsProgress &&
        (s.interactionsProgress = s.previousState.interactionsProgress),
      (i = t.override && !!t.override.loop),
      (s.$videoWrapper = J("<div>", { class: "h5p-video-wrapper" })),
      (s.$controls = J("<div>", {
        role: "toolbar",
        ...
        ((s.video = H5P.newRunnable(
          {
            ...
            params: {
              ...
              startAt: o,
              a11y: e,
              playback: { autoplay: t.override && !!t.override.autoplay },
            },
          },
          s.contentId,
          void 0,
            ...
            : (s.video.on("containerLoaded", function () {
              ...
              s.video.on("loaded", function () {
                ((a = !0),
                  ...
                  "number" == typeof o &&
                    0 !== o &&
                    (s.seek(o), s.updateCurrentTime(o)));
              }),
              ...
              s.video.on("stateChange", function (e) {
                !s.controls && a && (s.addControls(), s.trigger("resize"));
                var n = e.data;
                if (s.currentState !== Z.SEEKING)
                  switch (n) {
                    ...
                    case H5P.Video.PLAYING:
                      if (c) {
                        (s.addQualityChooser(),
                          ...
                          (c = !1));
                        var l = s.options.video.startScreenOptions.poster;
                        l &&
                          void 0 !== l.path &&
                          setTimeout(function () {
                            s.trigger("resize");
  ...
  ((Z.prototype = Object.create(H5P.EventDispatcher.prototype)),
    ...
    (Z.prototype.attach = function (t) {
      ...
      (I(t, [{ key: T.M }], function (t) {
        o(t, "$volume") || e.toggleMute(!1);
      }),
        I(t, [{ key: T.K }], function (t) {
          if (!o(t, "$play"))
            if (e.hasUncompletedRequiredInteractions()) {
              var n = J(document.activeElement);
              e.showWarningMask()
                .find(".h5p-button-back")
                .click(function () {
                  return n.focus();
    ...
    (Z.prototype.addControls = function () {
      ...
      var e = this.getDuration(),
        n = Z.humanizeTime(e),
        o = Z.formatTimeForA11y(e, this.l10n);
      if (
        (this.controls.$totalTime.find(".human-time").html(n),
        this.controls.$totalTime
          .find(".hidden-but-read")
          .html("".concat(this.l10n.totalTime, " ").concat(o)),
    ...
    (Z.prototype.loaded = function () {
      ...
      if (
        ...
        var e = et("interactions", this.editor.field.fields),
          n = et("duration", e.field.fields).fields;
        ((n[0].max = n[1].max = t), (n[0].min = n[1].min = 0));
        for (
          var o = et("adaptivity", e.field.fields).fields, i = 0;
          i < o.length;
          i++
        )
          o[i].fields && (et("seekTo", o[i].fields).max = t);
      }
      if (
    ...
    (Z.prototype.initInteraction = function (t) {
      var e,
        n = this,
        o = n.options.assets.interactions[t];
      if (n.override) {
        var i = {};
        (o.adaptivity && o.adaptivity.requireCompletion && (i.enableRetry = !0),
          H5P.jQuery.extend(o.action.params.behaviour, n.override, i));
      }
      void 0 !== n.previousState &&
        void 0 !== n.previousState.answers &&
        null !== n.previousState.answers[t] &&
        (e = n.previousState.answers[t]);
      var s = new L(o, n, e);
      return (
        s.on("display", function (t) {
          var e = t.data;
          (e.appendTo(n.$overlay), s.repositionToWrapper(n.$videoWrapper));
          var o = void 0 !== n.video.pressToPlay;
          (nt(o ? 100 : null, function () {
            (n.currentState === H5P.Video.PLAYING ||
              n.currentState === H5P.Video.BUFFERING) &&
              s.pause() &&
              (n.focusInteraction || (n.focusInteraction = s), n.video.pause());
          }),
            n.seekingTo && ((n.seekingTo = void 0), e.focus()),
            setTimeout(function () {
              s.positionLabel(n.$videoWrapper.width());
            }, 0),
            n.toggleEndscreen(!1));
        }),
        s.on("hide", function () {
        ...
        s.on("xAPI", function (t) {
          ...
          ("interacted" === e && this.setProgress(L.PROGRESS_INTERACTED),
            ...
            ] = "PT" + Math.floor(n.video.getCurrentTime()) + "S"));
        }),
        n.interactions.push(s),
        s
      );
    }),
    ...
    (Z.prototype.showPreventSkippingMessage = function () {
      var t,
        ...
        s = this;
      if (
        ((o.x = null !== (t = o.x) && void 0 !== t ? t : 0),
        (o.y = "number" == typeof o.y ? 25 - o.y : 25),
        ...
        var a = parseFloat(
            null !==
              (n = s.$preventSkippingMessage.css("transform").split(",")[4]) &&
              void 0 !== n
              ? n
              : 0,
          ),
        ...
        ((o.x -= d),
          ...
          s.$preventSkippingMessage.css("left", o.x),
          s.$preventSkippingMessage.css("bottom", o.y),
          setTimeout(function () {
            s.$preventSkippingMessage
              .addClass("h5p-show")
    ...
    (Z.prototype.onBookmarkSelect = function (t, e) {
      ...
      if (this.isSkippingProhibited(e.time))
        this.showPreventSkippingMessage(
          {
            x:
              (e.time / n.video.getDuration()) *
                n.controls.$slider.get(0).offsetWidth +
              2,
            y: -23,
          },
          n.l10n.navForwardDisabled,
        );
      else {
        (n.currentState !== H5P.Video.PLAYING &&
          ...
          n.video.play(),
          n.seek(e.time));
        var o = Z.formatTimeForA11y(e.time, n.l10n);
        setTimeout(function () {
          return n.read("".concat(n.l10n.currentTime, " ").concat(o));
        }, 150);
      }
    }),
    ...
    (Z.prototype.addBookmark = function (t, e) {
      ...
      (i
        ...
        void 0 === n.controls.$bookmarksList &&
          (n.controls.$bookmarksList = J('<ul role="menu"></ul>').insertAfter(
            n.controls.$bookmarksChooser.find("h2"),
          )));
      var s = J(
        '<li role="menuitem" aria-describedby="'
          .concat(n.bookmarksMenuId, '">')
          .concat(o.label, "</li>"),
      )
        .click(function () {
        ...
        .keydown(function (t) {
          (P(t) && n.onBookmarkSelect(i, o), t.stopPropagation());
        });
      n.bookmarkMenuKeyboardControls.addElement(s.get(0));
      var r = n.controls.$bookmarksList.children(":eq(" + t + ")");
      return (
        0 !== r.length
          ? s.insertBefore(r)
          : s.appendTo(n.controls.$bookmarksList),
        n.on("bookmarksChanged", function (o) {
          var r = o.data.index,
            a = o.data.number;
          r === t && a < 0
            ? (s.remove(), delete n.bookmarksMap[e])
            : t >= r && ((t += a), i.data("id", t));
        }),
    ...
    (Z.prototype.addEndscreen = function (t, e) {
      var n,
        o = this,
        i = o.options.assets.endscreens[t];
      if ((void 0 === e && (e = Math.floor(10 * i.time) / 10), !this.editor))
        return (
          o.getDuration() - e < 1 && (e = o.getDuration()),
          void (n = o.endscreensMap[e] = !0)
        );
      ((n = o.endscreensMap[e] =
        J(
          '<div class="h5p-endscreen" style="left:' +
            i.time * o.oneSecondInPercentage +
            '%"><div class="h5p-endscreen-label"><div class="h5p-endscreen-text">' +
            i.label +
            "</div></div></div>",
        )
          .appendTo(o.controls.$endscreensContainer)
          .data("id", t)
          .hover(
            function () {
              (void 0 !== o.endscreenTimeout &&
                clearTimeout(o.endscreenTimeout),
                o.controls.$endscreensContainer
                  .children(".h5p-show")
                  .removeClass("h5p-show"),
                n.addClass("h5p-show"));
            },
            function () {
              o.endscreenTimeout = setTimeout(
                function () {
                  n.removeClass("h5p-show");
                },
                o.editor ? 1e3 : 2e3,
              );
            },
        ...
        o.editor &&
          (o.endscreenTimeout = setTimeout(function () {
            n.removeClass("h5p-show");
          }, 1e3)),
        n
        ...
        void 0 === o.controls.$endscreensList &&
          (o.controls.$endscreensList = J('<ul role="menu"></ul>').insertAfter(
            o.controls.$endscreensChooser.find("h2"),
          )));
      var s = J(
        '<li role="menuitem" aria-describedby="'
          .concat(o.endscreensMenuId, '">')
          .concat(i.label, "</li>"),
      )
        .click(function () {
          return o.onEndscreenSelect(n, i);
        })
        .keydown(function (t) {
          (P(t) && o.onEndscreenSelect(n, i), t.stopPropagation());
        });
      o.endscreenMenuKeyboardControls.addElement(s.get(0));
      var r = o.controls.$endscreensList.children(":eq(" + t + ")");
      return (
        0 !== r.length
          ? s.insertBefore(r)
          : s.appendTo(o.controls.$endscreensList),
        o.on("endscreensChanged", function (i) {
          var r = i.data.index,
            a = i.data.number;
          r === t && a < 0
            ? (s.remove(), delete o.endscreensMap[e])
            : t >= r && ((t += a), n.data("id", t));
        }),
        o.trigger("endscreenAdded", { endscreen: n }),
        n
      );
    }),
    (Z.prototype.attachControls = function (t) {
      var e = this,
        n = J("<div/>", { class: "h5p-controls-left", appendTo: t });
      ...
      var o = J("<div/>", { class: "h5p-controls-right", appendTo: t });
      ...
      var i = function (t, n) {
          return function () {
            var o = e.controls[t],
              i = e.controls[n],
              s = "true" === o.attr("aria-disabled"),
              r = "true" === o.attr("aria-expanded");
            s ||
              (r
      ...
      ((e.minimalMenuKeyboardControls = new b([new g()])),
        ...
        (e.controls.$slider = J("<div/>", {
          ...
          max: 0,
          create: function (t) {
            var n = J(t.target).find(".ui-slider-handle");
            (n
              .attr("role", "slider")
          ...
          slide: function (t, n) {
            var o = x(t, [T.ARROW_LEFT, T.ARROW_RIGHT]),
              i = n.value;
            if ((e.isSkippingProhibited(i) && (i = e.maxTimeReached), o)) {
              var s = x(t, [T.ARROW_RIGHT]),
                r = e.getDuration();
          ...
          stop: function (t, n) {
            ...
            var o = e.isSkippingProhibited(n.value)
              ? e.maxTimeReached
              : n.value;
            (e.seek(o), e.recreateCurrentInteractions());
            var i =
              e.lastState === H5P.Video.PLAYING ||
            ...
            (e.isSkippingProhibited(n.value) &&
              (e.showPreventSkippingMessage(
                {
                  x:
                    (n.value / e.video.getDuration()) *
                    e.controls.$slider.get(0).offsetWidth,
                },
                e.l10n.navForwardDisabled,
              ),
              e.setSliderPosition(o)),
        ...
        "both" === e.preventSkippingMode &&
          ...
          e.controls.$slider.parent().click(function (t) {
            var n = e.menuitems
              ...
              ? t.target.offsetLeft
              : t.offsetX;
            return (e.showPreventSkippingMessage({ x: n, y: -13 }), !1);
          })),
        e.displayBookmarks() &&
    ...
    (Z.prototype.createButton = function (t, e, n, o, i) {
      var s = {
        role: "button",
        tabindex: 0,
        ...
        on: {
          ...
          keydown: function (t) {
            P(t) && (o.call(this), t.preventDefault(), t.stopPropagation());
          },
        },
        appendTo: n,
      };
    ...
    (Z.prototype.addQualityChooser = function () {
      ...
      if (
        ...
        for (var o = "", i = 0; i < n.length; i++) {
          var s = n[i],
            r = s.name === e;
          o += '<li role="menuitemradio" data-quality="'
            .concat(s.name, '" aria-checked="')
            .concat(r, '" aria-describedby="')
            .concat(t.qualityMenuId, '">')
            .concat(s.label, "</li>");
        }
        var a = J('<ul role="menu">'.concat(o, "</ul>")).appendTo(
        ...
        (a
          ...
          .keydown(function (e) {
            if (P(e)) {
              var n = J(this).attr("data-quality");
              t.updateQuality(n);
            }
            e.stopPropagation();
          }),
    ...
    (Z.prototype.addPlaybackRateChooser = function () {
      ...
      if (
        ...
        if (
          ...
          for (
            var o = this.video.getPlaybackRate(), i = "", s = 0;
            s < n.length;
            s++
          ) {
            var r = n[s],
          ...
          (c
            ...
            .keydown(function (t) {
              if (P(t)) {
                var n = J(this).attr("playback-rate");
    ...
    (Z.prototype.resize = function () {
      if (this.$container) {
        ...
        var o = this.justVideo ? 0 : this.$controls.height(),
          i = this.$container.height();
        if (n) {
          if ((e = this.$videoWrapper.height()) + o <= i)
            (this.$videoWrapper.css("marginTop", (i - o - e) / 2),
        ...
        if (((this.controlsCss = { bottom: "", maxHeight: r + "px" }), n)) {
          var a = o;
          (e + o <= i && (a = o + (i - o - e) / 2),
    ...
    (Z.prototype.resizeStartScreen = function () {
      ...
      var o = J(".h5p-splash-description", this.$splash),
    ...
    (Z.prototype.setSliderPosition = function (t) {
      try {
        var e = this.controls.$slider.find(".ui-slider-handle"),
          n = Z.formatTimeForA11y(t, this.l10n);
    ...
    (Z.prototype.updateCurrentTime = function (t) {
      ...
      var n = Z.humanizeTime(t),
        o = Z.formatTimeForA11y(t, e.l10n);
      (e.controls.$currentTime.html(n),
        e.controls.$currentTimeA11y.html(
          "".concat(e.l10n.currentTime, " ").concat(o),
        ),
    ...
    (Z.prototype.toggleFocusTrap = function () {
      ...
      e.length > 0
        ? this.$container.off("focusin").on("focusin", function (n) {
            return t.trapFocusInInteractions(e, J(n.target));
          })
    ...
    (Z.prototype.findNextInteractionToShow = function (t, e) {
      for (var n, o = 0; o < this.interactions.length; o++) {
    ...
    (Z.prototype.findNextInteractionToHide = function (t) {
      for (var e, n = 0; n < this.visibleInteractions.length; n++) {
        var o = this.interactions[this.visibleInteractions[n]].getDuration();
        (void 0 === e ||
          o.to <
            this.interactions[this.visibleInteractions[e]].getDuration().to) &&
          (e = n);
      }
      return e;
    }),
    ...
    (Z.prototype.resetTask = function () {
      ...
      (void 0 !== this.bubbleEndscreen && this.bubbleEndscreen.toggle(!1, !1),
      void 0 !== this.controls) &&
        (this.addSliderInteractions(),
        this.video.getCurrentTime() > 0 && this.seek(0),
        this.timeUpdate(-1),
    ...
    (Z.formatTimeForA11y = function (t, e) {
      var n = Z.secondsToMinutesAndHours(t),
        o = n.hours > 0 ? "".concat(n.hours, " ").concat(e.hours, ", ") : "";
      return ""
        .concat(o)
        .concat(n.minutes, " ")
        .concat(e.minutes, ", ")
