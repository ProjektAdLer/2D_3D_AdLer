...
import FullscreenSwitchViewModel from "~ReactComponents/FullscreenSwitch/FullscreenSwitchViewModel";
import * as useInjection from "inversify-react";
import FullscreenSwitchBuilder from "~ReactComponents/FullscreenSwitch/FullscreenSwitchBuilder";
