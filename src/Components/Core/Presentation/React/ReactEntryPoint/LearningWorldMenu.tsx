...
export default function LearningWorldMenu() {
  return (
    <React.Fragment>
      <div className="grid h-[90vh] max-h-screen grid-cols-10 grid-rows-6 m-6 border-4 rounded-lg root bg-adlerlightblue border-adlerdarkblue">
        <div className="col-span-10 col-start-1 row-start-1 p-2 text-4xl border-b-4 border-adlerdarkblue">
          <HeaderBar />
        </div>
