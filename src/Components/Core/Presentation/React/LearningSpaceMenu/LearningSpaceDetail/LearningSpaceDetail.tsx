  ...
  return (
    ...
    >
      <article className="flex min-h-0 w-full flex-1 flex-col gap-2 overflow-y-auto mobile-landscape:min-h-0 mobile-landscape:overflow-y-auto">
        <div className="flex flex-shrink-0 flex-row items-center justify-between border-b border-gray-500 p-1 pb-4 portrait:justify-center portrait:gap-2">
          ...
          {isAvailable && (
            <StyledButton
              ...
              data-testid="enter-learningspace"
            >
        ...
        <div className="flex min-h-0 w-full flex-1 flex-col gap-2 overflow-auto">
                  ...
                  return (
                    <div key={element.name} className="w-full">
                      <div className="flex w-full flex-row justify-between pr-4">
                        ...
                        {element.difficultyInfo?.difficultyType !==
                          undefined && (
          ...
          {viewModel.completionDisplay instanceof RequirementBasedDisplay ? (
            <section className="border-b border-gray-500 pb-2">
              <div className="ml-6 items-start !text-base font-medium lg:!text-lg mobile-landscape:!text-xs portrait:ml-3 portrait:!text-xs">
