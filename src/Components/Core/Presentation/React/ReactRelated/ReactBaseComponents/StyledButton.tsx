    ...
    <button
      ...
      className={tailwindMerge(
        ...
        disabled
          ...
          : tailwindMerge(
              "flex items-center text-sm rounded-lg hover:cursor-pointer lg:text-xl active:translate-x-1 active:translate-y-1 active:border-transparent text-adlerdarkblue font-regular border-t-[1px] border-l-[1px] border-b-4 border-r-4 border-adlerdarkblue overflow-hidden",
              buttonConfig[color]
            )
      )}
      {...rest}
