...
export default function NarrativeFramework(props: NarrativeFrameworkProps) {
  ...
  return (
    <div className="relative h-full w-full rounded-lg bg-suburbthemebg bg-cover bg-no-repeat p-4 mobile-landscape:w-[70vw]">
      <div className="absolute -left-6 top-56 flex items-start justify-start xl:-left-2 xl:top-56 mobile-landscape:top-16 tablet-portrait:top-96">
        <img alt="AdLer with a thumb up" src={explainAdler} className="w-32" />
        <div className="twok:top-15 relative -left-4 -top-24 z-50 mt-4 translate-y-[-50%] xl:-top-24 xl:left-4 xl:w-3/4 onek:-left-0 onek:-top-20 onek:mt-0 twok:left-2 mobile-landscape:-top-4 mobile-portrait:w-56 tablet-portrait:-top-48">
