...
const CampusAB_SocialArea: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Campus AB - Social Area",
    worldDescription:
      "Test world for CAMPUSASCHAFFENBURG_SOCIALAREA theme with all floor plans",
    worldGoals: [
      "Test CAMPUSASCHAFFENBURG_SOCIALAREA theme",
    ...
    topics: [
      {
        topicId: 1501,
        topicName: "Campus AB - Social Area Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Campus AB - Social Area - R6 Floor Plan",
        ...
        spaceTemplateStyle: "CAMPUSASCHAFFENBURG_SOCIALAREA",
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Campus AB - Social Area",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Campus AB - Social Area - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Campus AB - Social Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Campus AB - Social Area - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Campus AB - Social Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Campus AB - Social Area - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Campus AB - Social Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Campus AB - Social Area - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Campus AB - Social Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
...
export default CampusAB_SocialArea;
