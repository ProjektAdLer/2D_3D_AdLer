...
const CampusKE_StudentClub: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Campus KE - Student Club",
    worldDescription:
      "Test world for CAMPUSKE_SOCIALAREA theme with all floor plans",
    worldGoals: [
      "Test CAMPUSKE_SOCIALAREA theme",
    ...
    topics: [
      {
        topicId: 2301,
        topicName: "Campus KE - Student Club Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Campus KE - Student Club - R6 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Campus KE - Student Club",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Campus KE - Student Club - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Campus KE - Student Club",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Campus KE - Student Club - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Campus KE - Student Club",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Campus KE - Student Club - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Campus KE - Student Club",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Campus KE - Student Club - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Campus KE - Student Club",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
...
export default CampusKE_StudentClub;
