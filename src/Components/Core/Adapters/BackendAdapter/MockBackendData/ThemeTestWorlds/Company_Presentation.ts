...
const Company_Presentation: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Company - Presentation",
    worldDescription:
      "Test world for COMPANY_PRESENTATION theme with all floor plans",
    worldGoals: [
      "Test COMPANY_PRESENTATION theme",
    ...
    topics: [
      {
        topicId: 3301,
        topicName: "Company - Presentation Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Company - Presentation - R6 Floor Plan",
        ...
        spaceTemplateStyle: "COMPANY_PRESENTATION",
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Company - Presentation",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Company - Presentation - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Company - Presentation",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Company - Presentation - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Company - Presentation",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Company - Presentation - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Company - Presentation",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Company - Presentation - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Company - Presentation",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
