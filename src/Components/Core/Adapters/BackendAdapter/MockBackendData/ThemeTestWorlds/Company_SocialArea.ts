...
const Company_SocialArea: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Company - Social Area",
    worldDescription:
      "Test world for COMPANY_SOCIALAREA theme with all floor plans",
    worldGoals: [
      "Test COMPANY_SOCIALAREA theme",
    ...
    topics: [
      {
        topicId: 3501,
        topicName: "Company - Social Area Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Company - Social Area - R6 Floor Plan",
        ...
        spaceTemplateStyle: "COMPANY_SOCIALAREA",
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Company - Social Area",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Company - Social Area - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Company - Social Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Company - Social Area - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Company - Social Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Company - Social Area - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Company - Social Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Company - Social Area - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Company - Social Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
...
export default Company_SocialArea;
