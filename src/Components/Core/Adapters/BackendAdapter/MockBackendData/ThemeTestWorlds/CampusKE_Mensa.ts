...
const CampusKE_Mensa: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Campus KE - Mensa",
    worldDescription: "Test world for CAMPUSMENSA theme with all floor plans",
    worldGoals: [
      "Test CAMPUSMENSA theme",
    ...
    topics: [
      {
        topicId: 2101,
        topicName: "Campus KE - Mensa Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Campus KE - Mensa - R6 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Campus KE - Mensa",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Campus KE - Mensa - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Campus KE - Mensa",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Campus KE - Mensa - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Campus KE - Mensa",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Campus KE - Mensa - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Campus KE - Mensa",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Campus KE - Mensa - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Campus KE - Mensa",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
