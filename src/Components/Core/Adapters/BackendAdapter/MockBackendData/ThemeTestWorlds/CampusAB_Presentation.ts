...
const CampusAB_Presentation: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Campus AB - Presentation",
    worldDescription:
      "Test world for CAMPUSASCHAFFENBURG_PRESENTATION theme with all floor plans",
    worldGoals: [
      "Test CAMPUSASCHAFFENBURG_PRESENTATION theme",
    ...
    topics: [
      {
        topicId: 1301,
        topicName: "Campus AB - Presentation Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Campus AB - Presentation - R6 Floor Plan",
        ...
        spaceTemplateStyle: "CAMPUSASCHAFFENBURG_PRESENTATION",
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Campus AB - Presentation",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Campus AB - Presentation - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Campus AB - Presentation",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Campus AB - Presentation - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Campus AB - Presentation",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Campus AB - Presentation - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Campus AB - Presentation",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Campus AB - Presentation - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Campus AB - Presentation",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
...
export default CampusAB_Presentation;
