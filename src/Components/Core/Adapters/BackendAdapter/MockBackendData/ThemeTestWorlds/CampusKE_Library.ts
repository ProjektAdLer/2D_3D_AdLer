...
const CampusKE_Library: AWT = {
  ...
  world: {
    ...
    topics: [
      {
        topicId: 2201,
        topicName: "Campus KE - Library Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Campus KE - Library - R6 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Campus KE - Library",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Campus KE - Library - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Campus KE - Library",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Campus KE - Library - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Campus KE - Library",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Campus KE - Library - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Campus KE - Library",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Campus KE - Library - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Campus KE - Library",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
...
export default CampusKE_Library;
