...
const Company_EatingArea: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Company - Eating Area",
    worldDescription:
      "Test world for COMPANY_EATINGAREA theme with all floor plans",
    worldGoals: [
      "Test COMPANY_EATINGAREA theme",
    ...
    topics: [
      {
        topicId: 3201,
        topicName: "Company - Eating Area Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Company - Eating Area - R6 Floor Plan",
        ...
        spaceTemplateStyle: "COMPANY_EATINGAREA",
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Company - Eating Area",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Company - Eating Area - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Company - Eating Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Company - Eating Area - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Company - Eating Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Company - Eating Area - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Company - Eating Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Company - Eating Area - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Company - Eating Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
...
export default Company_EatingArea;
