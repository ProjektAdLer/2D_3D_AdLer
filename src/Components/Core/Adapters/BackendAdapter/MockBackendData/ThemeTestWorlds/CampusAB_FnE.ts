...
const CampusAB_FnE: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Campus AB - FnE",
    worldDescription:
      "Test world for CAMPUSASCHAFFENBURG_FNE theme with all floor plans",
    worldGoals: [
      "Test CAMPUSASCHAFFENBURG_FNE theme",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Campus AB - FnE - R6 Floor Plan",
        ...
        spaceTemplateStyle: "CAMPUSASCHAFFENBURG_FNE",
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Campus AB - FnE",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Campus AB - FnE - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Campus AB - FnE",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Campus AB - FnE - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Campus AB - FnE",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Campus AB - FnE - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Campus AB - FnE",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Campus AB - FnE - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Campus AB - FnE",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
