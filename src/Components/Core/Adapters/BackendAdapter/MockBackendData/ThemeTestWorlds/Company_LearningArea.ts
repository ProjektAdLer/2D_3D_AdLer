...
const Company_LearningArea: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Company - Learning Area",
    worldDescription:
      "Test world for COMPANY_LEARNINGAREA theme with all floor plans",
    worldGoals: [
      "Test COMPANY_LEARNINGAREA theme",
    ...
    topics: [
      {
        topicId: 3101,
        topicName: "Company - Learning Area Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Company - Learning Area - R6 Floor Plan",
        ...
        spaceTemplateStyle: "COMPANY_LEARNINGAREA",
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Company - Learning Area",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Company - Learning Area - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Company - Learning Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Company - Learning Area - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Company - Learning Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Company - Learning Area - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Company - Learning Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Company - Learning Area - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Company - Learning Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
...
export default Company_LearningArea;
