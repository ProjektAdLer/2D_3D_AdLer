...
const Company_TechnicalArea: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Company - Technical Area",
    worldDescription:
      "Test world for COMPANY_TECHNICALAREA theme with all floor plans",
    worldGoals: [
      "Test COMPANY_TECHNICALAREA theme",
    ...
    topics: [
      {
        topicId: 3601,
        topicName: "Company - Technical Area Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Company - Technical Area - R6 Floor Plan",
        ...
        spaceTemplateStyle: "COMPANY_TECHNICALAREA",
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Company - Technical Area",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Company - Technical Area - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Company - Technical Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Company - Technical Area - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Company - Technical Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Company - Technical Area - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Company - Technical Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Company - Technical Area - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Company - Technical Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
...
export default Company_TechnicalArea;
