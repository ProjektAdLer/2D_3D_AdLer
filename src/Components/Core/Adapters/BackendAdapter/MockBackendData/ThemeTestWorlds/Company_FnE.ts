...
const Company_FnE: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Company - FnE",
    worldDescription: "Test world for COMPANY_FNE theme with all floor plans",
    worldGoals: [
      "Test COMPANY_FNE theme",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Company - FnE - R6 Floor Plan",
      ...
      {
        spaceId: 2,
        spaceName: "Company - FnE - R8 Floor Plan",
      ...
      {
        spaceId: 3,
        spaceName: "Company - FnE - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Company - FnE",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Company - FnE - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Company - FnE",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Company - FnE - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Company - FnE",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
