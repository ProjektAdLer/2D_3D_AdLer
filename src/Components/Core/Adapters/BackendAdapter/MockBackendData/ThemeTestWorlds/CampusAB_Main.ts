...
const CampusAB_Main: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Campus AB - Main",
    worldDescription:
      "Test world for CAMPUSASCHAFFENBURG theme with all floor plans",
    worldGoals: [
      "Test CAMPUSASCHAFFENBURG theme",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Campus AB - Main - R6 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Campus AB - Main",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Campus AB - Main - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Campus AB - Main",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Campus AB - Main - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Campus AB - Main",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Campus AB - Main - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Campus AB - Main",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Campus AB - Main - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Campus AB - Main",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
