...
const CampusKE_ServerRoom: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Campus KE - Server Room",
    worldDescription:
      "Test world for CAMPUSKE_TECHNICALAREA theme with all floor plans",
    worldGoals: [
      "Test CAMPUSKE_TECHNICALAREA theme",
    ...
    topics: [
      {
        topicId: 2401,
        topicName: "Campus KE - Server Room Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Campus KE - Server Room - R6 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Campus KE - Server Room",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Campus KE - Server Room - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Campus KE - Server Room",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Campus KE - Server Room - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Campus KE - Server Room",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Campus KE - Server Room - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Campus KE - Server Room",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Campus KE - Server Room - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Campus KE - Server Room",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
...
export default CampusKE_ServerRoom;
