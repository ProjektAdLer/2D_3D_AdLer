...
const CampusAB_TechnicalArea: AWT = {
  fileVersion: "0.4",
  amgVersion: "1.0",
  author: "Theme Test",
  language: "de",
  world: {
    worldName: "Campus AB - Technical Area",
    worldDescription:
      "Test world for CAMPUSASCHAFFENBURG_TECHNICALAREA theme with all floor plans",
    worldGoals: [
      "Test CAMPUSASCHAFFENBURG_TECHNICALAREA theme",
    ...
    topics: [
      {
        topicId: 1601,
        topicName: "Campus AB - Technical Area Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Campus AB - Technical Area - R6 Floor Plan",
        ...
        spaceTemplateStyle: "CAMPUSASCHAFFENBURG_TECHNICALAREA",
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Campus AB - Technical Area",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Campus AB - Technical Area - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Campus AB - Technical Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Campus AB - Technical Area - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Campus AB - Technical Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Campus AB - Technical Area - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Campus AB - Technical Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Campus AB - Technical Area - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Campus AB - Technical Area",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
...
export default CampusAB_TechnicalArea;
