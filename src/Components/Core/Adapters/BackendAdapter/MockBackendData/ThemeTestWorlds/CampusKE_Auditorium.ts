...
const CampusKE_Auditorium: AWT = {
  ...
  world: {
    ...
    topics: [
      {
        topicId: 2601,
        topicName: "Campus KE - Auditorium Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Campus KE - Auditorium - R6 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Campus KE - Auditorium",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Campus KE - Auditorium - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Campus KE - Auditorium",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Campus KE - Auditorium - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Campus KE - Auditorium",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Campus KE - Auditorium - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Campus KE - Auditorium",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Campus KE - Auditorium - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Campus KE - Auditorium",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
...
export default CampusKE_Auditorium;
