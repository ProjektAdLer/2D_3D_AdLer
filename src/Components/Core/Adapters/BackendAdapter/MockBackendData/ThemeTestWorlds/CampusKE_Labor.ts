...
const CampusKE_Labor: AWT = {
  ...
  world: {
    ...
    topics: [
      {
        topicId: 2501,
        topicName: "Campus KE - Labor Test",
    ...
    spaces: [
      {
        spaceId: 1,
        spaceName: "Campus KE - Labor - R6 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R6 floor plan test for Campus KE - Labor",
            ],
      ...
      {
        spaceId: 2,
        spaceName: "Campus KE - Labor - R8 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the R8 floor plan test for Campus KE - Labor",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 3,
        spaceName: "Campus KE - Labor - L10 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the L10 floor plan test for Campus KE - Labor",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 4,
        spaceName: "Campus KE - Labor - T13 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the T13 floor plan test for Campus KE - Labor",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
      ...
      {
        spaceId: 5,
        spaceName: "Campus KE - Labor - D15 Floor Plan",
        ...
        spaceStory: {
          introStory: {
            storyTexts: [
              "Welcome to the D15 floor plan test for Campus KE - Labor",
            ],
            elementModel: "a_npc_defaultnpc",
          },
          outroStory: {
