...
export const LearningSpaceTheme_CampusAB: ILearningSpaceTheme = {
  ...
  entryDoorModel: require("../../../../Assets/3dModels/campusTheme/elevator_entry.glb"),
  exitDoorModel: require("../../../../Assets/3dModels/campusTheme/elevator_exit.glb"),
  ...
  insideDecorationModels: {
    [LearningSpaceTemplateType.L]: require("../../../../Assets/3dModels/campusTheme/Empty.glb"),
    [LearningSpaceTemplateType.R6]: require("../../../../Assets/3dModels/campusTheme/Empty.glb"),
    [LearningSpaceTemplateType.R8]: require("../../../../Assets/3dModels/campusTheme/Empty.glb"),
    [LearningSpaceTemplateType.D]: require("../../../../Assets/3dModels/campusTheme/Empty.glb"),
    [LearningSpaceTemplateType.T]: require("../../../../Assets/3dModels/campusTheme/Empty.glb"),
