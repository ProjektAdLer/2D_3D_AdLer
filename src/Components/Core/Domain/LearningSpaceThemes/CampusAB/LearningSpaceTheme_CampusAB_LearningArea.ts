...
export const LearningSpaceTheme_CampusAB_LearningArea: ILearningSpaceTheme = {
  ...
  ambienceModel: require("../../../../../Assets/3dModels/CampusAB/LearningArea/env-campus-ab-library.glb"),
