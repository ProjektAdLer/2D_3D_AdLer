...
export const LearningSpaceTheme_CampusAB: ILearningSpaceTheme = {
  ...
  standinDecorationModels: [
    ...
    require("../../../../../Assets/3dModels/CampusAB/Shared/d-dcomp-vendingmachine-1.glb"),
  ],
  entryDoorModel: require("../../../../../Assets/3dModels/CampusAB/Shared/d-door-campus-entry.glb"),
  exitDoorModel: require("../../../../../Assets/3dModels/CampusAB/Shared/d-door-campus-exit.glb"),
  windowModel: require("../../../../../Assets/3dModels/CampusAB/Shared/d-door-campus-window.glb"),
